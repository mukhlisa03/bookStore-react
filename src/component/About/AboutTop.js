            ...
            <div className="row">
              ...
              <div className="col-lg-6 col-md-12 col-sm-12 col-12">
                <div className="about_top_left_content">
                  <h2>ABOUT OUR BookHeaven Book STORE</h2>
                  <h4>
                  ...
                  <p>
                    ...
                    upheld the philosophy that "everyone can enjoy the relax of
                    books." Its business covers more than 220 countries and
                    regions around the world
                  </p>
                  <p>
                    The brand was founded in October 2021, and since then it has
                    upheld the philosophy that "everyone can{" "}
                    <strong>BOOKHEAVEN</strong> the relax of books." Its
                    business covers more than 220 countries and regions around
                    the world
                  </p>
                  <p>
                    The brand was founded in October 2021, and since then it has
                    upheld the philosophy that "everyone can enjoy the{" "}
                    <strong>BOOKHEAVEN</strong> of books." Its business covers
